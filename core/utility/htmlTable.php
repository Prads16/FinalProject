...
class htmlTable
{
    ...
    {
        $tableGen = '<table class="table-hover align-items-center table table-bordered">';
        $tableGen .= '<tr class="active">';
    ...
    {
        $tableGen = '<table class="table-hover align-items-center table table-bordered"><tr>';
        $tableGen .= '<tr>';
